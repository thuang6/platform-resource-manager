...
class Metric(str, Enum):
    ...
    OCRL3MRD = 'offcore_request_l3_miss_demand_data_rd'
    OCRL3MPKI = 'offcore_request_l3_miss_demand_data_rd_per_kilo_instruction'
    OCRL3PM = 'offcore_request_l3_miss_demand_data_rd_per_miss'
